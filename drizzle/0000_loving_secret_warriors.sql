...
CREATE TYPE "public"."MessageTrigger" AS ENUM('BOOKING_CREATED', 'BOOKING_CONFIRMED', 'BOOKING_CANCELLED', 'BOOKING_REMINDER_24H', 'BOOKING_REMINDER_2H', 'BOOKING_COMPLETED', 'APPROVAL_REQUIRED', 'BOOKING_APPROVED', 'BOOKING_REJECTED', 'PAYMENT_RECEIVED', 'INVOICE_SENT');--> statement-breakpoint
...
CREATE TYPE "public"."NotificationType" AS ENUM('BOOKING_CREATED', 'BOOKING_CONFIRMED', 'BOOKING_CANCELLED', 'BOOKING_REMINDER', 'BOOKING_RESCHEDULED', 'BOOKING_COMPLETED', 'PAYMENT_RECEIVED', 'PAYMENT_FAILED', 'INVOICE_SENT', 'INVOICE_OVERDUE', 'SHIFT_ASSIGNED', 'SHIFT_REMINDER', 'ROUTE_UPDATED', 'SYSTEM_ALERT', 'MAINTENANCE', 'FEATURE_UPDATE', 'PROMOTION', 'REVIEW_REQUEST');--> statement-breakpoint
...
CREATE TABLE "project_members" (
	...
	"responsibilities" text[] DEFAULT '{"RAY"}',
	"weeklyHours" integer,
...
CREATE TABLE "organization_settings" (
	...
	"minNoticeHours" integer DEFAULT 24 NOT NULL,
	"bufferMinutes" integer DEFAULT 15 NOT NULL,
	"allowSameDayBook" boolean DEFAULT false NOT NULL,
	"slotDurationMins" integer DEFAULT 30 NOT NULL,
	"senderName" text,
	"senderEmail" text,
	"replyToEmail" text,
	"emailFooter" text,
	...
	"createdAt" timestamp(3) DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updatedAt" timestamp(3) NOT NULL,
	"availabilityMode" "AvailabilityMode" DEFAULT 'CALENDAR_BASED' NOT NULL,
	"capacityMode" "CapacityMode" DEFAULT 'TENANT_LEVEL' NOT NULL,
	"defaultSlotCapacity" integer DEFAULT 1 NOT NULL,
	"slotApprovalEnabled" boolean DEFAULT false NOT NULL,
	"slotApprovalHours" integer DEFAULT 48 NOT NULL,
	"customCss" text,
	"fontFamily" text,
	"secondaryColor" text
);
...
ALTER TABLE "tenant_module_settings" ADD CONSTRAINT "tenant_module_settings_tenantId_moduleId_fkey" FOREIGN KEY ("tenantId","moduleId") REFERENCES "public"."tenant_modules"("tenantId","moduleId") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."projects"("id") ON DELETE set null ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "audit_logs_tenantId_entityType_entityId_idx" ON "audit_logs" USING btree ("tenantId" uuid_ops,"entityType" uuid_ops,"entityId" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "customers_tenantId_email_key" ON "customers" USING btree ("tenantId" text_ops,"email" text_ops);--> statement-breakpoint
CREATE INDEX "customers_tenantId_idx" ON "customers" USING btree ("tenantId" uuid_ops);--> statement-breakpoint
CREATE INDEX "customers_tenantId_lastName_idx" ON "customers" USING btree ("tenantId" text_ops,"lastName" uuid_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "message_templates_tenantId_trigger_channel_serviceId_key" ON "message_templates" USING btree ("tenantId" uuid_ops,"trigger" enum_ops,"channel" uuid_ops,"serviceId" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "sent_messages_tenantId_createdAt_idx" ON "sent_messages" USING btree ("tenantId" timestamp_ops,"createdAt" timestamp_ops);--> statement-breakpoint
...
CREATE INDEX "notifications_userId_createdAt_idx" ON "notifications" USING btree ("userId" timestamp_ops,"createdAt" uuid_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "invoices_tenantId_invoiceNumber_key" ON "invoices" USING btree ("tenantId" uuid_ops,"invoiceNumber" text_ops);--> statement-breakpoint
...
CREATE INDEX "tasks_assignedTo_dueDate_idx" ON "tasks" USING btree ("assignedTo" timestamp_ops,"dueDate" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "tasks_tenantId_status_idx" ON "tasks" USING btree ("tenantId" enum_ops,"status" uuid_ops);--> statement-breakpoint
CREATE INDEX "projects_startDate_idx" ON "projects" USING btree ("startDate" timestamp_ops);--> statement-breakpoint
CREATE INDEX "projects_tenantId_priority_idx" ON "projects" USING btree ("tenantId" uuid_ops,"priority" enum_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "module_settings_moduleId_key_key" ON "module_settings" USING btree ("moduleId" uuid_ops,"key" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "tenant_module_settings_tenantId_moduleId_settingKey_key" ON "tenant_module_settings" USING btree ("tenantId" text_ops,"moduleId" text_ops,"settingKey" text_ops);--> statement-breakpoint
...
CREATE INDEX "bookings_staffId_scheduledDate_idx" ON "bookings" USING btree ("staffId" uuid_ops,"scheduledDate" date_ops);--> statement-breakpoint
CREATE INDEX "bookings_tenantId_scheduledDate_idx" ON "bookings" USING btree ("tenantId" uuid_ops,"scheduledDate" date_ops);--> statement-breakpoint
CREATE INDEX "bookings_tenantId_status_idx" ON "bookings" USING btree ("tenantId" enum_ops,"status" enum_ops);--> statement-breakpoint
...
CREATE INDEX "available_slots_tenantId_available_idx" ON "available_slots" USING btree ("tenantId" bool_ops,"available" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "available_slots_tenantId_date_time_idx" ON "available_slots" USING btree ("tenantId" text_ops,"date" date_ops,"time" date_ops);--> statement-breakpoint
CREATE INDEX "tenant_portals_tenantId_isActive_idx" ON "tenant_portals" USING btree ("tenantId" uuid_ops,"isActive" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "workflow_executions_tenantId_startedAt_idx" ON "workflow_executions" USING btree ("tenantId" uuid_ops,"startedAt" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "workflows_triggerEvent_idx" ON "workflows" USING btree ("triggerEvent" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "users_tenantId_email_key" ON "users" USING btree ("tenantId" uuid_ops,"email" text_ops);--> statement-breakpoint
CREATE INDEX "users_tenantId_idx" ON "users" USING btree ("tenantId" uuid_ops);--> statement-breakpoint
CREATE INDEX "user_availability_userId_dayOfWeek_idx" ON "user_availability" USING btree ("userId" int4_ops,"dayOfWeek" uuid_ops);--> statement-breakpoint
CREATE INDEX "user_availability_userId_idx" ON "user_availability" USING btree ("userId" uuid_ops);--> statement-breakpoint
CREATE INDEX "user_availability_userId_specificDate_idx" ON "user_availability" USING btree ("userId" uuid_ops,"specificDate" date_ops);--> statement-breakpoint
CREATE INDEX "user_capacities_tenantId_date_idx" ON "user_capacities" USING btree ("tenantId" date_ops,"date" uuid_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "user_integrations_tenantId_userId_provider_key" ON "user_integrations" USING btree ("tenantId" enum_ops,"userId" uuid_ops,"provider" enum_ops);--> statement-breakpoint
...
CREATE INDEX "user_integration_sync_logs_userIntegrationId_startedAt_idx" ON "user_integration_sync_logs" USING btree ("userIntegrationId" uuid_ops,"startedAt" timestamp_ops);--> statement-breakpoint
...
CREATE INDEX "user_external_events_userId_endTime_idx" ON "user_external_events" USING btree ("userId" uuid_ops,"endTime" timestamp_ops);--> statement-breakpoint
CREATE INDEX "user_external_events_userId_startTime_idx" ON "user_external_events" USING btree ("userId" uuid_ops,"startTime" timestamp_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "user_external_events_userIntegrationId_externalEventId_key" ON "user_external_events" USING btree ("userIntegrationId" uuid_ops,"externalEventId" uuid_ops);--> statement-breakpoint
