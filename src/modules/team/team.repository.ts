...
function mapToStaffMember(
  ...
  return {
    ...
    addressPostcode: profile?.addressPostcode ?? null,
    addressCountry: profile?.addressCountry ?? null,
    dateOfBirth: profile?.dateOfBirth ?? null,
    taxId: profile?.taxId ?? null,
    dayRate: profile?.dayRate !== null && profile?.dayRate !== undefined ? Number(profile.dayRate) : null,
    mileageRate: profile?.mileageRate !== null && profile?.mileageRate !== undefined ? Number(profile.mileageRate) : null,
