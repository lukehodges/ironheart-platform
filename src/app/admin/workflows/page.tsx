    ...
    <tr onClick={onClick} style={{
      ...
      <td style={{ padding: "10px 14px 10px 10px" }} onClick={e => e.stopPropagation()}>
        <Popover align="right" width={170} trigger={
          ...
          <>
            <Link href={`/admin/workflows/${wf.id}`} style={{ textDecoration: "none" }}>
              <PopoverItem onClick={close}>Open</PopoverItem>
            </Link>
            <Link href={`/admin/workflows/${wf.id}/edit`} style={{ textDecoration: "none" }}>
    ...
    <aside key={wf.id} className="animate-slide-in-right" style={{
      ...
      <div style={{ padding: "14px 16px", borderBottom: "1px solid var(--ih-line)", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
        ...
        <div style={{ display: "flex", gap: 4 }}>
          <Link href={`/admin/workflows/${wf.id}`} className="ih-btn ih-btn-quiet ih-btn-icon" style={{ height: 24, width: 24, textDecoration: "none" }} title="Open full page">
      ...
      <div className="scrollbar-thin" style={{ flex: 1, overflowY: "auto", padding: 16 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
          ...
          <Link href={`/admin/workflows/${wf.id}/executions`} className="ih-btn ih-btn-quiet ih-btn-sm" style={{ height: 20, fontSize: 10, textDecoration: "none" }}>
            View all
          </Link>
        </div>
      ...
      <div style={{ borderTop: "1px solid var(--ih-line)", padding: 12, display: "flex", flexDirection: "column", gap: 6, background: "var(--ih-surface)" }}>
        <Link href={`/admin/workflows/${wf.id}`} className="ih-btn ih-btn-accent" style={{ width: "100%", textDecoration: "none", justifyContent: "center" }}>
      ...
      <section style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "18px 20px 14px", borderBottom: "1px solid var(--ih-line)" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
            <div>
              <div className="ih-eyebrow" style={{ marginBottom: 6 }}>Automation · {viewLabel}</div>
            ...
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              ...
              <Link href="/admin/workflows/wf-quote-followup/edit" className="ih-btn ih-btn-primary ih-btn-sm" style={{ textDecoration: "none" }}>
