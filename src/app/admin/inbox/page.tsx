  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        ...
        <Link href={`/admin/workflows/${wf.runId.split("_")[0]}-${wf.runId.split("_")[1]}/executions`} className="ih-btn ih-btn-quiet" style={{ height: 32, textDecoration: "none", justifyContent: "flex-start" }}>
...
function PaymentDetail({ item, onAction }: { item: PaymentItem; onAction: (label: string, tone: ToastTone) => void }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        <Link href={`/admin/payments/${p.invoiceId}`} className="ih-btn ih-btn-accent" style={{ height: 36, justifyContent: "center", textDecoration: "none" }}>
...
function AuditDetail({ item, onAction }: { item: AuditItem; onAction: (label: string, tone: ToastTone) => void }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        <Link href="/admin/audit" className="ih-btn ih-btn-accent" style={{ height: 36, justifyContent: "center", textDecoration: "none" }}>
...
function PipelineDetail({ item, onAction }: { item: PipelineItem; onAction: (label: string, tone: ToastTone) => void }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        {d.engagementId && (
          <Link href={`/admin/clients/${d.engagementId}`} className="ih-btn ih-btn-accent" style={{ height: 36, justifyContent: "center", textDecoration: "none" }}>
            <Icon name="handshake" size={12} /> Open new engagement
          </Link>
        )}
        <Link href={`/admin/pipeline/${d.dealId}`} className="ih-btn ih-btn-ghost" style={{ height: 32, textDecoration: "none", justifyContent: "flex-start" }}>
...
function FormDetail({ item, onAction }: { item: FormItem; onAction: (label: string, tone: ToastTone) => void }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        <Link href={`/admin/forms/submissions/${f.submissionId}`} className="ih-btn ih-btn-accent" style={{ height: 36, justifyContent: "center", textDecoration: "none" }}>
...
function BookingDetail({ item, onAction }: { item: BookingItem; onAction: (label: string, tone: ToastTone) => void }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "grid", gap: 6 }}>
        <Link href={`/admin/bookings/${b.bookingId}`} className="ih-btn ih-btn-accent" style={{ height: 36, justifyContent: "center", textDecoration: "none" }}>
    ...
    <div style={{ display: "grid", gridTemplateColumns: selected ? "260px 1fr 380px" : "260px 1fr", height: "calc(100vh - 120px)", margin: "-24px -24px 0" }}>
      ...
      <div style={{ overflowY: "auto" }} className="scrollbar-thin">
        <div style={{ padding: "20px 24px 12px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
          <div>
            <div className="ih-eyebrow">{items.length} event{items.length !== 1 ? "s" : ""} · last 24h</div>
