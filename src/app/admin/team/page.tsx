    ...
    <Popover align="right" width={200} trigger={
      ...
      {(close) => (
        <>
          ...
          <Link href={`/admin/calendar?owner=${m.id}`} style={{ textDecoration: "none" }}>
    ...
    <aside key={m.id} className="animate-slide-in-right" style={{
      ...
      <div style={{ padding: "14px 16px", borderBottom: "1px solid var(--ih-line)", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
        ...
        <div style={{ display: "flex", gap: 4 }}>
          <Link href={`/admin/team/${m.id}`} className="ih-btn ih-btn-quiet ih-btn-icon" style={{ height: 24, width: 24, textDecoration: "none" }} title="Open full page">
        ...
        <div className="ih-card" style={{ padding: 12, display: "flex", alignItems: "center", gap: 10 }}>
          {m.manager ? (
            <>
              ...
              <Link href={`/admin/team/${m.manager.id}`} style={{ fontSize: 12.5, fontWeight: 500, textDecoration: "none", color: "inherit" }}>{m.manager.name}</Link>
            </>
          ) : (
      ...
      <div style={{ borderTop: "1px solid var(--ih-line)", padding: 12, display: "flex", flexDirection: "column", gap: 6, background: "var(--ih-surface)" }}>
        <Link href={`/admin/team/${m.id}`} className="ih-btn ih-btn-accent" style={{ width: "100%", textDecoration: "none", justifyContent: "center" }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <Link href={`/admin/calendar?owner=${m.id}`} className="ih-btn ih-btn-ghost ih-btn-sm" style={{ flex: 1, textDecoration: "none", justifyContent: "center" }}>
      ...
      <section style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
        <div style={{ padding: "18px 20px 14px", borderBottom: "1px solid var(--ih-line)" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
            <div>
              <div className="ih-eyebrow" style={{ marginBottom: 6 }}>Team · workspace</div>
