// TODO(data-wiring): needs trpc.analytics.getKPIs, trpc.analytics.activityFeed (BUILD), trpc.consulting.list, trpc.booking.listForCalendar, trpc.pipeline.* — entire page currently rendering MOCK data
"use client"
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 14, marginBottom: 28 }}>
        ...
        <div className="ih-card">
          ...
          <div style={{ padding: "10px 18px", textAlign: "center" }}>
            <Link href="/platform/audit-log" className="ih-btn ih-btn-quiet ih-btn-sm" style={{ textDecoration: "none" }}>View full timeline →</Link>
          </div>
        </div>
