  ...
  return (
    <div className="ih-card" style={{ padding: 28 }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0 }}>
        ...
        {m.manager ? (
          <>
            <Link href={`/platform/team/${m.manager.id}`} className="ih-card" style={{ padding: "8px 14px", textDecoration: "none", color: "inherit", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ position: "relative", display: "flex", gap: 20, paddingTop: 0 }}>
              ...
              {m.directReports.map(r => (
                <div key={r.id} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                  <div style={{ width: 1, height: 24, background: "var(--ih-line-2)" }} />
                  <Link href={`/platform/team/${r.id}`} className="ih-card" style={{ padding: "8px 12px", textDecoration: "none", color: "inherit", display: "flex", alignItems: "center", gap: 8, minWidth: 160 }}>
    ...
    <div className="ih-card" style={{ padding: 0, overflow: "hidden" }}>
      <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--ih-line)" }}>
        <SectionHeader eyebrow={`${m.recentActivity.length} events`} title="Audit log" action={
          <Link href={`/platform/audit-log`} className="ih-btn ih-btn-ghost ih-btn-sm" style={{ textDecoration: "none" }}>
    ...
    <aside style={{ width: 280, flexShrink: 0, padding: "0 0 0 16px", borderLeft: "1px solid var(--ih-line)", position: "sticky", top: 60 }}>
      ...
      <div className="ih-card" style={{ padding: 14 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <Link href={`/platform/calendar?owner=${m.id}`} className="ih-btn ih-btn-ghost ih-btn-sm" style={{ textDecoration: "none", justifyContent: "center" }}>
  ...
  if (!member) {
    return (
      <div style={{ padding: 40, textAlign: "center" }}>
        ...
        <Link href="/platform/team" className="ih-btn ih-btn-accent ih-btn-sm" style={{ textDecoration: "none" }}>
    ...
    <div style={{ margin: "-24px -24px" }}>
      ...
      <div style={{ padding: "22px 28px 18px", borderBottom: "1px solid var(--ih-line)", background: "var(--ih-bg)" }}>
        <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 10 }}>
          <Link href="/platform/team" className="ih-btn ih-btn-quiet ih-btn-sm" style={{ padding: "2px 6px", textDecoration: "none" }}>
            <Icon name="chevronLeft" size={12} /> Team
          </Link>
          <span className="ih-eyebrow">/{member.id} · member · <span style={{ color: "var(--ih-accent)" }}>★ Demo data</span></span>
        </div>
          ...
          <div style={{ display: "flex", gap: 18, alignItems: "flex-end" }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 10, display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                ...
                {member.manager && (
                  <Link href={`/platform/team/${member.manager.id}`} className="ih-pill" style={{ fontSize: 9, textDecoration: "none", color: "var(--ih-ink-65)" }}>
      ...
      <ConfirmDialog
        ...
        confirmTone="danger"
        onConfirm={() => { setToast({ message: `Archived ${member.name}`, tone: "warn" }); setArchiveOpen(false); router.push("/platform/team") }}
