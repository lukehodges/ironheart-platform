    ...
    <div style={{ margin: "-24px -24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 0 }}>
        ...
        <div style={{ padding: "20px 20px 48px", background: "var(--ih-surface-2)" }}>
          ...
          <Link href="/platform/clients/c-northwind" style={{ textDecoration: "none", color: "inherit" }}>
          ...
          {/* Related invoice */}
          <Link href="/platform/payments/inv-1" style={{ textDecoration: "none", color: "inherit" }}>
