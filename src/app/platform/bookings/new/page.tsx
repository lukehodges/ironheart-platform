    ...
    <div style={{ margin: "-24px -24px" }}>
      ...
      <div style={{ padding: "24px 28px 18px", borderBottom: "1px solid var(--ih-line)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
            <button className="ih-btn ih-btn-quiet ih-btn-sm" style={{ padding: "2px 6px" }} onClick={() => router.push("/platform/bookings")}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Btn sm ghost onClick={() => router.push("/platform/bookings")}>Cancel</Btn>
          <Btn sm accent onClick={() => { setToast({ message: "Booking created", tone: "ok" }); setTimeout(() => router.push("/platform/bookings"), 1500) }}><Icon name="calendar" size={11} /> Book</Btn>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 680, padding: "28px 28px 48px" }}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end" }}>
          <Btn sm ghost onClick={() => router.push("/platform/bookings")}>Cancel</Btn>
          <Btn sm accent onClick={() => { setToast({ message: "Booking created", tone: "ok" }); setTimeout(() => router.push("/platform/bookings"), 1500) }}><Icon name="calendar" size={11} /> Book session</Btn>
        </div>
      </div>
