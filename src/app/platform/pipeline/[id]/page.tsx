  ...
  if (!baseDeal) {
    return (
      <div style={{ padding: 40 }}>
        ...
        <Link href="/platform/pipeline" className="ih-btn ih-btn-quiet ih-btn-sm" style={{ textDecoration: "none" }}>
      ...
      <div style={{ padding: "24px 28px 18px", borderBottom: "1px solid var(--ih-line)", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8 }}>
            <Link href="/platform/pipeline" className="ih-btn ih-btn-quiet ih-btn-sm" style={{ padding: "2px 6px", textDecoration: "none" }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          {deal.engagementId
            ? <Link href={`/platform/clients/${deal.engagementId}`} className="ih-btn ih-btn-ghost ih-btn-sm" style={{ textDecoration: "none" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: 0 }}>
        ...
        <div style={{ padding: "20px 28px 48px", borderRight: "1px solid var(--ih-line)" }}>
          ...
          {deal.proposals.map(p => (
            <Link key={p.id} href={`/platform/clients/${deal.customer.id}/proposals/${p.id}`} style={{ textDecoration: "none", color: "inherit" }}>
        ...
        <div style={{ padding: "20px 20px 48px", background: "var(--ih-surface-2)" }}>
          ...
          {/* Customer card */}
          <Link href={`/platform/customers/${deal.customer.id}`} style={{ textDecoration: "none", color: "inherit" }}>
          ...
          {deal.engagementId && (
            <Link href={`/platform/clients/${deal.engagementId}`} style={{ textDecoration: "none", color: "inherit" }}>
          ...
          <div className="ih-card" style={{ background: "var(--ih-surface)", padding: 12, display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <button className="ih-btn ih-btn-ghost ih-btn-sm" style={{ justifyContent: "flex-start" }} onClick={() => { router.push(`/platform/customers/${deal.customer.id}`) }}>
