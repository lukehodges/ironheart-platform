    ...
    <div style={{ padding: "24px 28px 48px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 24, gap: 24, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <Link href="/platform/payments/new" className="ih-btn ih-btn-primary ih-btn-sm" style={{ textDecoration: "none" }}><Icon name="plus" size={12}/> New invoice</Link>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 14 }}>
        ...
        <div className="ih-card" style={{ overflow: "hidden" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
            ...
            <tbody>
              {INVOICES.map((inv) => (
                <tr key={inv.id} onClick={() => router.push(`/platform/payments/${inv.id}`)} style={{ borderTop: "1px solid var(--ih-line)", cursor: "pointer" }}>
